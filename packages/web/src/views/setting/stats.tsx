...
const Stats: React.FC = () => {
  ...
  return (
    <div className="max-w-[1080px] mx-auto">
      <div className="mt-11 text-xl font-medium">👋 kebai，这是你和语雀相伴的第 1118 天</div>
      <div className="mt-3 text-sm font-normal text-muted-foreground">数据更新至 2024-03-21（每日上午更新昨日数据，&quot;--&quot;表示暂无数据）</div>
      <div className="border p-6 rounded-xl mt-8" style={{ backgroundImage: "linear-gradient(180deg,rgba(246,252,254,.69),hsla(0,0%,100%,0))" }}>
        <div className="flex justify-between items-start">
          <div>
            <h2 className="text-lg font-medium">数据总览</h2>
            <p className=" text-sm font-normal mt-1 text-muted-foreground">你的每一份成长都被记录</p>
          </div>
          <DropdownMenu>
